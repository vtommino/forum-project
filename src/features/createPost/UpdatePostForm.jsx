...
function UpdatePostForm({ onSuccess, data }) {
  console.log(data);
  ...
  const handleSubmit = async (e) => {
    try {
      ...
      const response = await postApi.updatePost(formData);
            ...
            <div className="flex flex-col bg-white border border-yellow-500 rounded-xl gap-1 p-8">
              <div className="flex items-center gap-5">
                ...
                <div className="flex flex-col ">
                  ...
                  <div>
                    Image must not exceed 100KB and must be the size of 400 x
                    400 px.
                  </div>
                </div>
              </div>
